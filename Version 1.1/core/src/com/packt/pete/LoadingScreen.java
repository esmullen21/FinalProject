...
public class LoadingScreen extends ScreenAdapter {
    ...
    public void show() {
        ...
        peteGame.getAssetManager().load("bullet.png", Texture.class);
        peteGame.getAssetManager().load("newMap.tmx", TiledMap.class);
        peteGame.getAssetManager().load("badPete.png", Texture.class);
    }
